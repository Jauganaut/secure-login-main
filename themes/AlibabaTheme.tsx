...
const AlibabaTheme: React.FC<AlibabaThemeProps> = ({ prefilledEmail }) => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Validate agreement
    if (!agreed) {
      alert(lang === 'zh' ? '请阅读并同意服务条款和隐私政策' : 'Please read and agree to the Terms of Service and Privacy Policy');
      return;
    }
              ...
              <form onSubmit={handleLogin} className="p-8 space-y-6">
                ...
                <div className="flex items-start text-[12px] leading-snug text-gray-500 pt-2">
                  ...
                  <label htmlFor="aliyun-agreement" className="cursor-pointer">
                    {lang === 'zh' ? '我已阅读并同意' : 'I have read and agree with'} <a href="#" className="text-blue-500">Privacy Policy</a>, <a href="#" className="text-blue-500">Product Service Agreement</a>
                  </label>
                </div>
              </form>
